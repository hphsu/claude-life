#!/usr/bin/env python3
"""
Convert JL's fortune-telling markdown analyses to HTML and generate final report
"""
...
def main():
    ...
    # Input files
    json_path = data_dir / "fortune_tell_JL_20251029_212351.json"
    bazi_md_path = data_dir / "八字命理分析報告_JL_20251029.md"
    ziwei_md_path = data_dir / "紫微斗數分析報告_JL_20251029.md"
    astrology_md_path = data_dir / "心理占星分析報告_JL_20251029.md"
    synthesis_md_path = data_dir / "綜合分析報告_JL_20251029.md"
    ...
    birth_time = basic_info['birth_gregorian'].split()[1] if len(basic_info['birth_gregorian'].split()) > 1 else '21:40'
    location = basic_info.get('location', '汕頭')
    gender = '女性' if basic_info.get('gender') == '女' else '男性'
    ...
    # Save final HTML
    output_path = data_dir / "fortune_tell_JL_20251029_212351.html"
